...
-- ALTER TABLE AKTIVITET DROP CONSTRAINT AKTIVITET_RAAD_FK;
-- ALTER TABLE RAAD DROP CONSTRAINT RAAD_KARTLEGGING_FK;
-- ALTER TABLE SVARALTERNATIV DROP CONSTRAINT SVARALTERNATIV_BESVARELSE_FK;
-- ALTER TABLE BESVARELSE DROP CONSTRAINT BESVARELSE_KARTLEGGING_FK;
-- DROP TABLE AKTIVITET;
-- DROP TABLE RAAD;
-- DROP TABLE SVARALTERNATIV;
-- DROP TABLE BESVARELSE;
-- DROP TABLE KARTLEGGING;
-- DROP SEQUENCE AKTIVITET_SEQ;
-- DROP SEQUENCE RAAD_SEQ;
-- DROP SEQUENCE SVARALTERNATIV_SEQ;
-- DROP SEQUENCE BESVARELSE_SEQ;
-- DROP SEQUENCE KARTLEGGING_SEQ;
