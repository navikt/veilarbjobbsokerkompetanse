...
import no.nav.tjeneste.domene.brukerdialog.jobbsokerkompetanse.v1.informasjon.JobbsokerKartlegging;
...
public class JobbsokerkompetanseWSImpl implements JobbsokerkompetanseV1 {
    ...
    public HentJobbsokerKartleggingResponse hentJobbsokerKartlegging(HentNyesteJobbsokerKartleggingRequest hentNyesteJobbsokerKartleggingRequest) {
        val res = new HentJobbsokerKartleggingResponse();
        val kartlegging = new JobbsokerKartlegging();
        kartlegging.setId(1L);
        kartlegging.setLagretTidspunkt(DateParser.getXmlCalendar(new Date()));
        kartlegging.setBesvarelse("Dette er en testbesvarelse");
        kartlegging.setRaad("Dette er et råd.");
        res.setJobbsokerkartlegging(kartlegging);
        return res;
    }
